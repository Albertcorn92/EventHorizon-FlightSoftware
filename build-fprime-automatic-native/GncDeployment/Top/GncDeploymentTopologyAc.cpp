// ======================================================================
// \title  GncDeploymentTopologyAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for GncDeployment topology
// ======================================================================
...
namespace GncDeployment {
  ...
  GncDeployment::ProximityDriver proximityDriver(FW_OPTIONAL_NAME("proximityDriver"));
...
namespace GncDeployment {
  ...
  Svc::BufferManager uartBufferManager(FW_OPTIONAL_NAME("uartBufferManager"));

}

namespace GncDeployment {

  Drv::LinuxUartDriver uartDriver(FW_OPTIONAL_NAME("uartDriver"));
...
namespace GncDeployment {
  ...
  namespace ConfigObjects {
    ...
    namespace CdhCore_health {
      Svc::Health::PingEntry pingEntries[NUM_PING_ENTRIES] = {
        ...
        {
          PingEntries::GncDeployment_cmdSeq::WARN,
          PingEntries::GncDeployment_cmdSeq::FATAL,
          "GncDeployment_cmdSeq"
        },
        {
          PingEntries::GncDeployment_rateGroup1::WARN,
          PingEntries::GncDeployment_rateGroup1::FATAL,
          "GncDeployment_rateGroup1"
        },
        {
          PingEntries::GncDeployment_rateGroup2::WARN,
          PingEntries::GncDeployment_rateGroup2::FATAL,
          "GncDeployment_rateGroup2"
        },
        {
          PingEntries::GncDeployment_rateGroup3::WARN,
          PingEntries::GncDeployment_rateGroup3::FATAL,
          "GncDeployment_rateGroup3"
        },
      };
    }
  ...
  void initComponents(const TopologyState& state) {
    ...
    GncDeployment::chronoTime.init(InstanceIds::GncDeployment_chronoTime);
    GncDeployment::cmdSeq.init(QueueSizes::GncDeployment_cmdSeq, InstanceIds::GncDeployment_cmdSeq);
    GncDeployment::comDriver.init(InstanceIds::GncDeployment_comDriver);
    GncDeployment::proximityDriver.init(QueueSizes::GncDeployment_proximityDriver, InstanceIds::GncDeployment_proximityDriver);
    GncDeployment::rateGroup1.init(QueueSizes::GncDeployment_rateGroup1, InstanceIds::GncDeployment_rateGroup1);
    GncDeployment::rateGroup2.init(QueueSizes::GncDeployment_rateGroup2, InstanceIds::GncDeployment_rateGroup2);
    GncDeployment::rateGroup3.init(QueueSizes::GncDeployment_rateGroup3, InstanceIds::GncDeployment_rateGroup3);
    GncDeployment::rateGroupDriver.init(InstanceIds::GncDeployment_rateGroupDriver);
    GncDeployment::systemResources.init(InstanceIds::GncDeployment_systemResources);
    GncDeployment::timer.init(InstanceIds::GncDeployment_timer);
    GncDeployment::uartBufferManager.init(InstanceIds::GncDeployment_uartBufferManager);
    GncDeployment::uartDriver.init(InstanceIds::GncDeployment_uartDriver);
  }
  ...
  void setBaseIds() {
    ...
    GncDeployment::rateGroup1.setIdBase(BaseIds::GncDeployment_rateGroup1);
    GncDeployment::rateGroup2.setIdBase(BaseIds::GncDeployment_rateGroup2);
    GncDeployment::rateGroup3.setIdBase(BaseIds::GncDeployment_rateGroup3);
    GncDeployment::cmdSeq.setIdBase(BaseIds::GncDeployment_cmdSeq);
    GncDeployment::proximityDriver.setIdBase(BaseIds::GncDeployment_proximityDriver);
    GncDeployment::chronoTime.setIdBase(BaseIds::GncDeployment_chronoTime);
    GncDeployment::rateGroupDriver.setIdBase(BaseIds::GncDeployment_rateGroupDriver);
    GncDeployment::systemResources.setIdBase(BaseIds::GncDeployment_systemResources);
    GncDeployment::timer.setIdBase(BaseIds::GncDeployment_timer);
    GncDeployment::comDriver.setIdBase(BaseIds::GncDeployment_comDriver);
    GncDeployment::uartDriver.setIdBase(BaseIds::GncDeployment_uartDriver);
    GncDeployment::uartBufferManager.setIdBase(BaseIds::GncDeployment_uartBufferManager);
  }
  ...
  void connectComponents() {
    ...
    CdhCore::cmdDisp.set_seqCmdStatus_OutputPort(
        1,
        GncDeployment::cmdSeq.get_cmdResponseIn_InputPort(0)
    );
    GncDeployment::cmdSeq.set_comCmdOut_OutputPort(
        0,
    ...
    CdhCore::cmdDisp.set_compCmdSend_OutputPort(
        10,
        GncDeployment::cmdSeq.get_cmdIn_InputPort(0)
    );
    CdhCore::cmdDisp.set_compCmdSend_OutputPort(
        11,
        GncDeployment::proximityDriver.get_cmdIn_InputPort(0)
    );
    CdhCore::cmdDisp.set_compCmdSend_OutputPort(
        12,
        GncDeployment::systemResources.get_CmdDisp_InputPort(0)
    );
    ...
    GncDeployment::cmdSeq.set_cmdRegOut_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdReg_InputPort(10)
    );
    GncDeployment::proximityDriver.set_cmdRegOut_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdReg_InputPort(11)
    );
    GncDeployment::systemResources.set_CmdReg_OutputPort(
        0,
    ...
    GncDeployment::cmdSeq.set_cmdResponseOut_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdStat_InputPort(0)
    );
    GncDeployment::proximityDriver.set_cmdResponseOut_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdStat_InputPort(0)
    );
    GncDeployment::systemResources.set_CmdStatus_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdStat_InputPort(0)
    );
    ...
    ComCcsds::comStub.set_drvReceiveReturnOut_OutputPort(
        0,
        GncDeployment::comDriver.get_recvReturnIn_InputPort(0)
    );
    ComCcsds::comStub.set_drvSendOut_OutputPort(
        0,
        GncDeployment::comDriver.get_send_InputPort(0)
    );
    GncDeployment::comDriver.set_allocate_OutputPort(
        0,
        ComCcsds::commsBufferManager.get_bufferGetCallee_InputPort(0)
    );
    GncDeployment::comDriver.set_deallocate_OutputPort(
        0,
        ComCcsds::commsBufferManager.get_bufferSendIn_InputPort(0)
    );
    GncDeployment::comDriver.set_ready_OutputPort(
        0,
        ComCcsds::comStub.get_drvConnected_InputPort(0)
    );
    GncDeployment::comDriver.set_recv_OutputPort(
        0,
    ...
    GncDeployment::cmdSeq.set_logOut_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    GncDeployment::proximityDriver.set_logOut_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    GncDeployment::rateGroup1.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    GncDeployment::rateGroup2.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    GncDeployment::rateGroup3.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    GncDeployment::systemResources.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    GncDeployment::uartBufferManager.set_eventOut_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    GncDeployment::uartDriver.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    ...
    // GncDeployment
    GncDeployment::proximityDriver.set_deallocate_OutputPort(
        0,
        GncDeployment::uartBufferManager.get_bufferSendIn_InputPort(0)
    );
    GncDeployment::uartDriver.set_allocate_OutputPort(
        0,
        GncDeployment::uartBufferManager.get_bufferGetCallee_InputPort(0)
    );
    GncDeployment::uartDriver.set_ready_OutputPort(
        0,
        GncDeployment::proximityDriver.get_ready_InputPort(0)
    );
    GncDeployment::uartDriver.set_recv_OutputPort(
        0,
        GncDeployment::proximityDriver.get_serialRecv_InputPort(0)
    );
    ...
    CdhCore::health.set_PingSend_OutputPort(
        8,
        GncDeployment::cmdSeq.get_pingIn_InputPort(0)
    );
    CdhCore::health.set_PingSend_OutputPort(
        9,
        GncDeployment::rateGroup1.get_PingIn_InputPort(0)
    );
    CdhCore::health.set_PingSend_OutputPort(
        10,
        GncDeployment::rateGroup2.get_PingIn_InputPort(0)
    );
    CdhCore::health.set_PingSend_OutputPort(
        11,
        GncDeployment::rateGroup3.get_PingIn_InputPort(0)
    );
    ...
    GncDeployment::cmdSeq.set_pingOut_OutputPort(
        0,
        CdhCore::health.get_PingReturn_InputPort(8)
    );
    GncDeployment::rateGroup1.set_PingOut_OutputPort(
        0,
        CdhCore::health.get_PingReturn_InputPort(9)
    );
    GncDeployment::rateGroup2.set_PingOut_OutputPort(
        0,
        CdhCore::health.get_PingReturn_InputPort(10)
    );
    GncDeployment::rateGroup3.set_PingOut_OutputPort(
        0,
    ...
    GncDeployment::proximityDriver.set_prmGetOut_OutputPort(
        0,
        FileHandling::prmDb.get_getPrm_InputPort(0)
    );
    GncDeployment::proximityDriver.set_prmSetOut_OutputPort(
        0,
        FileHandling::prmDb.get_setPrm_InputPort(0)
    );

    // RateGroups
    GncDeployment::rateGroup1.set_RateGroupMemberOut_OutputPort(
        0,
    ...
    GncDeployment::rateGroup1.set_RateGroupMemberOut_OutputPort(
        2,
        GncDeployment::systemResources.get_run_InputPort(0)
    );
    GncDeployment::rateGroup1.set_RateGroupMemberOut_OutputPort(
        3,
    ...
    GncDeployment::rateGroup1.set_RateGroupMemberOut_OutputPort(
        4,
        ComCcsds::aggregator.get_timeout_InputPort(0)
    );
    GncDeployment::rateGroup2.set_RateGroupMemberOut_OutputPort(
        0,
        GncDeployment::cmdSeq.get_schedIn_InputPort(0)
    );
    GncDeployment::rateGroup3.set_RateGroupMemberOut_OutputPort(
        0,
    ...
    GncDeployment::rateGroupDriver.set_CycleOut_OutputPort(
        0,
        GncDeployment::rateGroup1.get_CycleIn_InputPort(0)
    );
    GncDeployment::rateGroupDriver.set_CycleOut_OutputPort(
        1,
        GncDeployment::rateGroup2.get_CycleIn_InputPort(0)
    );
    GncDeployment::rateGroupDriver.set_CycleOut_OutputPort(
        2,
        GncDeployment::rateGroup3.get_CycleIn_InputPort(0)
    );
    GncDeployment::timer.set_CycleOut_OutputPort(
        0,
        GncDeployment::rateGroupDriver.get_CycleIn_InputPort(0)
    );
    ...
    GncDeployment::cmdSeq.set_tlmOut_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    GncDeployment::proximityDriver.set_tlmOut_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    GncDeployment::rateGroup1.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    GncDeployment::rateGroup2.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    GncDeployment::rateGroup3.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    GncDeployment::systemResources.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    GncDeployment::uartBufferManager.set_tlmOut_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    GncDeployment::uartDriver.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    ...
    GncDeployment::cmdSeq.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    GncDeployment::proximityDriver.set_logTextOut_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    GncDeployment::rateGroup1.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    GncDeployment::rateGroup2.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    GncDeployment::rateGroup3.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    GncDeployment::systemResources.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    GncDeployment::uartBufferManager.set_textEventOut_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    GncDeployment::uartDriver.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    ...
    CdhCore::cmdDisp.set_Time_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
    ...
    GncDeployment::cmdSeq.set_timeCaller_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
    GncDeployment::proximityDriver.set_timeCaller_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
    GncDeployment::rateGroup1.set_Time_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
    GncDeployment::rateGroup2.set_Time_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
    GncDeployment::rateGroup3.set_Time_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
    GncDeployment::systemResources.set_Time_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
    GncDeployment::uartBufferManager.set_timeCaller_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
    GncDeployment::uartDriver.set_Time_OutputPort(
        0,
        GncDeployment::chronoTime.get_timeGetPort_InputPort(0)
    );
  ...
  void regCommands() {
    ...
    GncDeployment::cmdSeq.regCommands();
    GncDeployment::systemResources.regCommands();
  }
  ...
  void startTasks(const TopologyState& state) {
    ...
    GncDeployment::cmdSeq.start(
      static_cast<FwTaskPriorityType>(Priorities::GncDeployment_cmdSeq),
      static_cast<Os::Task::ParamType>(StackSizes::GncDeployment_cmdSeq),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::GncDeployment_cmdSeq)
    );
    GncDeployment::proximityDriver.start(
      static_cast<FwTaskPriorityType>(Priorities::GncDeployment_proximityDriver),
      static_cast<Os::Task::ParamType>(StackSizes::GncDeployment_proximityDriver),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::GncDeployment_proximityDriver)
    );
    GncDeployment::rateGroup1.start(
      static_cast<FwTaskPriorityType>(Priorities::GncDeployment_rateGroup1),
      static_cast<Os::Task::ParamType>(StackSizes::GncDeployment_rateGroup1),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::GncDeployment_rateGroup1)
    );
    GncDeployment::rateGroup2.start(
      static_cast<FwTaskPriorityType>(Priorities::GncDeployment_rateGroup2),
      static_cast<Os::Task::ParamType>(StackSizes::GncDeployment_rateGroup2),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::GncDeployment_rateGroup2)
    );
    GncDeployment::rateGroup3.start(
      static_cast<FwTaskPriorityType>(Priorities::GncDeployment_rateGroup3),
      static_cast<Os::Task::ParamType>(StackSizes::GncDeployment_rateGroup3),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::GncDeployment_rateGroup3)
    );
  }
  ...
  void stopTasks(const TopologyState& state) {
    ...
    GncDeployment::cmdSeq.exit();
    GncDeployment::proximityDriver.exit();
    GncDeployment::rateGroup1.exit();
    GncDeployment::rateGroup2.exit();
    GncDeployment::rateGroup3.exit();
  }
  ...
  void freeThreads(const TopologyState& state) {
    ...
    (void) GncDeployment::cmdSeq.ActiveComponentBase::join();
    (void) GncDeployment::proximityDriver.ActiveComponentBase::join();
    (void) GncDeployment::rateGroup1.ActiveComponentBase::join();
    (void) GncDeployment::rateGroup2.ActiveComponentBase::join();
    (void) GncDeployment::rateGroup3.ActiveComponentBase::join();
  }
