// ======================================================================
// \title  GncDeploymentTopologyAc.hpp
// \author Generated by fpp-to-cpp
// \brief  hpp file for GncDeployment topology
// ======================================================================

#ifndef GncDeployment_GncDeploymentTopologyAc_HPP
#define GncDeployment_GncDeploymentTopologyAc_HPP
...
namespace GncDeployment {
  ...
  //! proximityDriver
  extern GncDeployment::ProximityDriver proximityDriver;
...
namespace GncDeployment {
  ...
  //! uartBufferManager
  extern Svc::BufferManager uartBufferManager;
...
namespace GncDeployment {
  ...
  //! uartDriver
  extern Drv::LinuxUartDriver uartDriver;
...
namespace GncDeployment {
  ...
  namespace BaseIds {
    enum {
      ...
      GncDeployment_rateGroup1 = 0x10001000,
      GncDeployment_rateGroup2 = 0x10002000,
      GncDeployment_rateGroup3 = 0x10003000,
      GncDeployment_cmdSeq = 0x10004000,
      GncDeployment_proximityDriver = 0x10005000,
      GncDeployment_chronoTime = 0x10010000,
      GncDeployment_rateGroupDriver = 0x10011000,
      GncDeployment_systemResources = 0x10012000,
      GncDeployment_timer = 0x10013000,
      GncDeployment_comDriver = 0x10014000,
      GncDeployment_uartDriver = 0x10015000,
      GncDeployment_uartBufferManager = 0x10016000,
    };
  }
  ...
  namespace InstanceIds {
    enum {
      ...
      FileHandling_prmDb,
      GncDeployment_chronoTime,
      GncDeployment_cmdSeq,
      GncDeployment_comDriver,
      GncDeployment_proximityDriver,
      GncDeployment_rateGroup1,
      GncDeployment_rateGroup2,
      GncDeployment_rateGroup3,
      GncDeployment_rateGroupDriver,
      GncDeployment_systemResources,
      GncDeployment_timer,
      GncDeployment_uartBufferManager,
      GncDeployment_uartDriver,
    };
  }
  ...
  namespace Priorities {
    enum {
      ...
      GncDeployment_cmdSeq = 40,
      GncDeployment_proximityDriver = 49,
      GncDeployment_rateGroup1 = 43,
      GncDeployment_rateGroup2 = 42,
      GncDeployment_rateGroup3 = 41,
    };
  }
  ...
  namespace QueueSizes {
    enum {
      ...
      GncDeployment_cmdSeq = 10,
      GncDeployment_proximityDriver = 10,
      GncDeployment_rateGroup1 = 10,
      GncDeployment_rateGroup2 = 10,
      GncDeployment_rateGroup3 = 10,
    };
  }
  ...
  namespace StackSizes {
    enum {
      ...
      GncDeployment_cmdSeq = 65536,
      GncDeployment_proximityDriver = 65536,
      GncDeployment_rateGroup1 = 65536,
      GncDeployment_rateGroup2 = 65536,
      GncDeployment_rateGroup3 = 65536,
    };
  }
